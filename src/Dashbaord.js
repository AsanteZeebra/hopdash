                    ...
                    <div className="d-flex gap-3">
                      <div className="">
                        ...
                        <p className="text-secondary m-0">
                          <span className="bi bi-record-fill text-primary me-1"></span>
                          Overall Income
                        </p>
                      </div>
                      ...
                      <div className="">
                        ...
                        <p className="text-secondary m-0">
                          <span className="bi bi-record-fill text-danger me-1"></span>
                          Overall Expenses
                        </p>
                      </div>
                    </div>
        ...
        <div className="app-hero-header d-flex align-items-start">
          <ol className="breadcrumb">
            <li className="breadcrumb-item">
              ...
              <a to="index.html" className="text-decoration-none">
                Home
              </a>
            </li>
                    ...
                    <div className="my-2">
                      <div className="d-flex position-relative activity-block">
                        ...
                        <div className="mb-5">
                          ...
                          <span className="bg-warning bg-opacity-10 p-2">
                            Tema Branch - Present
                          </span>
                        </div>
                      </div>
...
export const User = () => {
  ...
  return (
    <>
      <div className="app-container">
        <div className="app-hero-header d-flex align-items-start"></div>
